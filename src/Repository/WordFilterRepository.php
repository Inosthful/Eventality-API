...
/**
 * @extends ServiceEntityRepository<WordFilter>
 *
...
class WordFilterRepository extends ServiceEntityRepository
{
    ...
    public function save(WordFilter $entity, bool $flush = false): void
    {
    ...
    public function remove(WordFilter $entity, bool $flush = false): void
    {
